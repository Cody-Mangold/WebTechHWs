...
<!--home-->
     ...
     <section id = "home" >
		...
		<div id="fNamefeedback" >
			</div>
		<span id="fNameStatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
		...
		<div id="lNamefeedback" >
			</div>
		<span id="lNameStatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
	...
	<span id="userStatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
	...
	<div class = "form-group has-feedback">
		...
		<input type="password" class = "form-control" id="password" name = "password" />  <div id="passwordfeedback">
			</div>
	<span id="passStatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
	 ...
	 <div class = "form-group has-feedback">   
		...
		<div id="Commentsfeedback" >
			</div>
		 	<span id="commentsStatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
